...
export const CHANGELOG: Release[] = [
  {
    version: '3.8',
    date: '2026-09-17',
    title: 'A manufacturer is a client too: brand films beside dealership films, and Assamese',
    changes: [
  ...
  },
  {
    ...
    changes: [
      "Viewers see everything and change nothing. A viewer is somebody being shown the app, so every section is in their menu except APIs & models. Instructions, Languages, People, Analytics and What’s new open on a lightly blurred sketch of the page — its layout shows through, never its data, since a blur comes off with one line of CSS — saying the section is not available for viewer access and what it does. In Projects, Clients, Vehicles and Actors every field reads as filled in and none can be changed: no new, save, delete, import, sync or draw.",
      ...
      "A tour of every page a viewer can use. Tour this page, in the tab bar, walks through Projects, Clients, Vehicles, Actors and a project with a spotlight on each part — in a project, the three steps a film is made in, ending in the video editor. A viewer is shown each page’s tour the first time they open it.",
  ...
  },
  {
    version: '3.6',
    date: '2026-09-14',
    title: 'What each campaign earns, actors drawn from a sentence, and logos where the client wants them',
    changes: [
